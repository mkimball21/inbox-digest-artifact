...
// ============================ TEST STUBS (H5 harness) ============================
// Below, the five functions that call the real Messages API / MCP servers are
// replaced with deterministic local stubs so this exact component tree can be
// exercised in a plain browser via Playwright. Everything else in this file
// (parser, grouping, storage helpers, refs, scroll nav, action handlers,
// render tree) is byte-for-byte the real inbox-digest.jsx.
